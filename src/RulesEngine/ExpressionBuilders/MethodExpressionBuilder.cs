...
{
    internal sealed class MethodExpressionBuilder : RuleExpressionBuilderBase
    {
        private readonly ReSettings _reSettings;
        private readonly RuleExpressionParser _ruleExpressionParser;

        internal MethodExpressionBuilder(ReSettings reSettings, RuleExpressionParser ruleExpressionParser)
        {
        ...
        internal override RuleFunc<RuleResultTree> BuildDelegateForRule(Rule rule, RuleParameter[] ruleParams)
        {
            try
            {
                var ruleDelegate = _ruleExpressionParser.Compile<MethodExpressionResult>(rule.Expression, ruleParams);
            ...
            catch (Exception ex)
            {
                ...
                MethodExpressionResult func(object[] param) => new MethodExpressionResult();
